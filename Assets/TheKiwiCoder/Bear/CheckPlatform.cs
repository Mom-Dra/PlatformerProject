...
public class CheckPlatform : ActionNode
{
    ...
    protected override State OnUpdate()
    {
        ...
        RaycastHit hit;
        if (Physics.Raycast(context.transform.position + Vector3.up * 2f + context.transform.forward * forwardLength, Vector3.down, out hit, downLength, LayerMask.GetMask("Platform")))
        {
